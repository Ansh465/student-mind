...
export function AIAssistant() {
    ...
    return (
        <div className="card rounded-2xl flex-1 flex flex-col bg-[var(--bg-card)] border-[var(--border)] overflow-hidden">
            {/* Header */}
            ...
            {/* Chat Area */}
            <div className="flex-1 relative min-h-[300px] bg-[var(--bg-input)]/20">
                <div
                    ref={scrollRef}
                    className="absolute inset-0 overflow-y-auto p-4 space-y-4 scroll-smooth custom-scrollbar"
                >
                    {messages.map((msg, i) => (
